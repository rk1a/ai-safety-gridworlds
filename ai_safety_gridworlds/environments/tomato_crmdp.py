...
# Copyright 2018 David Lindner https://github.com/jvmncs/ai-safety-gridworlds
...
# ============================================================================
"""
This environment differs from the default tomato watering environment only
by the observations in the corrupt state. Instead of observing watered tomatoes
in all cells, the agent now sees the true state of the tomatoes and just gets
a corrupted reward signal. This modification makes the environment a CRMDP.

All changes compared to the default tomato watering environment are marked with
a comment, that starts with 'CHANGE:'.
"""
