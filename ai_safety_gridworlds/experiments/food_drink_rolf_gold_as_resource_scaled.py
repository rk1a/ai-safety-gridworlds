...
def init_experiment_flags():
    ...
    empirical_rescale = 14.13427
    es = empirical_rescale
    ...
    FLAGS.DRINK_REWARD = mo_reward({"DRINK_REWARD": 0.02 * es, "FOOD_REWARD": -0.018 * es, "GOLD_REWARD": 0})
    FLAGS.FOOD_REWARD = mo_reward({"DRINK_REWARD": -0.09 * es, "FOOD_REWARD": 0.1 * es, "GOLD_REWARD": 0})
    FLAGS.NON_DRINK_REWARD = mo_reward({"DRINK_REWARD": 0})
    FLAGS.NON_FOOD_REWARD = mo_reward({"FOOD_REWARD": 0})

    FLAGS.GAP_REWARD = mo_reward({"FOOD_REWARD": -0.001 * es, "DRINK_REWARD": -0.001 * es, "GOLD_REWARD": 0})

    FLAGS.GOLD_REWARD = mo_reward({"FOOD_REWARD": -0.018 * es, "DRINK_REWARD": -0.09 * es, "GOLD_REWARD": 0.1 * es})
...
def main(unused_argv):
    ...
    for trial_no in range(0, 2):
        ...
        for episode_no in range(0, 2):
            ...
            ui = safety_ui_ex.make_human_curses_ui_with_noop_keys(GAME_BG_COLOURS, GAME_FG_COLOURS,
